...
public static class Annexe06Renderer
{
    ...
    private static void Draw(Canvas c, ProcesVerbal pv, Beneficiaire b)
    {
        ...
        AddText(c, FormatDate(pv.DateVisite), lm + 70, y, 9, bold: true);
        ...
        AddText(c, FormatDate(b.DateDecision), lm + 9, y, 9, bold: true);
        ...
        AddText(c, FormatDate(pv.DatePermis), lm + 81, y, 9, bold: true);
        ...
        // FAIT À
        AddCenteredText(c, $"FAIT à {pv.Lieu}  LE : {FormatDate(pv.DatePV)}",
            lm + cw / 2, y, cw / 2, 8.5);
        y += 8;
